          ...
          <div className="w-[115%] bg-gray-100 p-3 mt-5 rounded-3xl flex-col flex gap-3">
              ...
              <div className="flex justify-evenly">
                  ...
                  <div className="w-[55%] items-center ml-[10px]">
                      <h3>Microsoft Software Ind</h3>
                      <h4 className='text-gray-500'>Microsoft's offical</h4>
                  </div>
                  <div>
                      <button className="bg-black text-white rounded-full h-8 w-[80px] font-semibold">Follow</button>
                  </div>
              </div>
              <div className="flex justify-evenly">
                  <div>
                  ...
                  <div className="w-[55%] items-center ml-[10px]">
                      <h3>META Software Lim</h3>
                      <h4 className='text-gray-500'>META's offical</h4>
                  </div>
                  <div>
                      <button className="bg-black text-white rounded-full h-8 w-[80px] font-semibold">Follow</button>
                  </div>
              ...
              <div className="flex justify-evenly">
                  ...
                  <div className="w-[55%] items-center ml-[10px]">
                      <h3>Google MNC company</h3>
                      <h4 className='text-gray-500'>Google's offical</h4>
                  </div>
                  <div>
                      <button className="bg-black text-white rounded-full h-8 w-[80px] font-semibold">Follow</button>
                  </div>
